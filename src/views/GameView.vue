...
<template>
  <div class="fixed inset-0 w-screen h-screen bg-black overflow-hidden font-kanit">
    ...
    <div class="absolute top-0 inset-x-0 z-20 flex justify-center px-2 sm:px-4 mt-2 sm:mt-3 pointer-events-none">
      <div class="pointer-events-auto bg-black/50 backdrop-blur-md border-[#c874b2]/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.8)] hover:border-[#c874b2]/40 transition-colors duration-500 pt-2 pb-2 sm:pt-2 sm:pb-3 px-4 sm:px-11 max-w-5xl w-full rounded-3xl sm:rounded-4xl text-center text-shadow-2xs border-4 space-y-2">
          <div class="flex items-center justify-between gap-2">
              ...
              <h1 class="text-lg sm:text-3xl md:text-5xl font-bold text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] mt-1 sm:mt-2 shadow-2xl tracking-tight leading-tight text-center drop-shadow-[0_0_10px_rgba(200,116,178,0.8) font-kanit">
                  SHOOT-AN-ALIEN
              </h1>
              <div class="bg-[#c874b2]/20 space-y-1 inline-block px-3 sm:px-8 py-1 rounded-4xl shadow-2xl ">
                  <h1 class="text-2xl sm:text-4xl md:text-5xl text-white text-shadow-2xs ">
                      03.00
                  </h1>
              </div>
